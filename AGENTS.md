...
| `.agents/skills/fabio-*/SKILL.md` (6 intent-scoped sub-skills) | `data/skills/*.json` (authored judgment) + `commands.json` (command index) | `subskills_match_generated` | New command/subcommand added, or a `data/skills/*.json` family edited |
...
ghcr.io/iemejia/fabio:0.44.0       # release version
ghcr.io/iemejia/fabio:0.44         # major.minor
```
